        ...
        if ($errCount < 1){
            ...
            if ($userRes) {
                ...
                if ($currPass === $userRes['Password']){
                    ...
                    echo "<br>";
                    echo "<div class='text-center'>Thanks for approving the password change ". $userRes['Name'] . "! Request processing...</div>";
            ...
            if ($pass_change){
                if(updatePassword($username, $newPass)){
                    echo "<div class='text-center' style='color: green' >Password Changed Successfully!</div>";
                }
            }
